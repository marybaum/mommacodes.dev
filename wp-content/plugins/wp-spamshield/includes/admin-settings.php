...
/** BEGIN **/
			...
			if( !isset( $spamshield_options['form_mail_encode_base64'] ) )	{ $spamshield_options['form_mail_encode_base64']	= 0; }
			...
			if( !empty( $_POST['submitted_wpss_contact_options'] ) && rs_wpss_is_user_admin() && check_admin_referer('wpss_update_contact_options_token','uco_tkn') ) {
				...
				$valid_post_spamshield_options = !empty( $_POST ) ? $_POST : array();
				$wpss_options_default = unserialize( WPSS_OPTIONS_DEFAULT );
				$wpss_options_contact_boolean = array ( 'form_include_website', 'form_require_website', 'form_include_phone', 'form_require_phone', 'form_include_company', 'form_require_company', 'form_include_drop_down_menu', 'form_require_drop_down_menu', 'form_include_user_meta', 'form_mail_encode_base64' );
				...
				if( !empty( $_POST['form_message_recipient'] ) && is_string( $_POST['form_message_recipient'] ) ) {
					...
					$valid_post_spamshield_options['form_message_recipient'] = is_email( $form_message_recipient_temp ) ? $form_message_recipient_temp : $wpss_admin_email;
			...
			?>
					...
					<label for="form_message_width">
						<?php $form_message_width = (int) rs_wpss_sanitize_string($spamshield_options['form_message_width']); ?>
					...
					<label for="form_message_height">
						<?php $form_message_height = (int) rs_wpss_sanitize_string($spamshield_options['form_message_height']); ?>
					...
					<label for="form_message_min_length">
						<?php $form_message_min_length = (int) rs_wpss_sanitize_string($spamshield_options['form_message_min_length']); ?>
					...
					<label for="form_message_recipient">
						<?php $form_message_recipient = rs_wpss_sanitize_string($spamshield_options['form_message_recipient']); ?>
						<input type="email" size="40" id="form_message_recipient" name="form_message_recipient" value="<?php if( empty( $form_message_recipient ) || !is_email( $form_message_recipient ) ) { echo $wpss_admin_email; } else { echo $form_message_recipient; } ?>" />
					...
					<li>
					<label for="form_encode">
						<input type="checkbox" id="form_mail_encode_base64" name="form_mail_encode_base64" <?php echo ($spamshield_options['form_mail_encode_base64']==TRUE?'checked="checked"':'') ?> value="1" />
